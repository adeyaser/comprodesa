    ...
    <div class="container-fluid px-4">
        <div class="row align-items-center g-5">
            <div class="col-lg-6">
                ...
                <img src="https://images.unsplash.com/photo-1596422846543-75c6fc197f07?auto=format&fit=crop&q=80&w=1000" class="img-fluid rounded-4 shadow-lg" alt="Village Landscape">
            </div>
            <div class="col-lg-6">
            ...
            <?php else: ?>
                ...
                <div class="col-md-4">
                    <div class="news-card card h-100 bg-white">
                        <img src="<?= !empty($news['thumbnail']) ? base_url('uploads/news/' . $news['thumbnail']) : 'https://placehold.co/800x400?text=No+Image' ?>" class="card-img-top" alt="<?= $news['title'] ?>">
                    ...
                    <?php if(!empty($featured_tourism)): ?>
                        ...
                        <div class="col-md-6">
                            <div class="tourism-card position-relative rounded-4 overflow-hidden shadow-sm" style="height: 250px;">
                                <img src="<?= !empty($spot['thumbnail']) ? base_url('uploads/tourism/' . $spot['thumbnail']) : 'https://placehold.co/600x400?text=No+Image' ?>" class="w-100 h-100 object-fit-cover" alt="<?= $spot['name'] ?>">
