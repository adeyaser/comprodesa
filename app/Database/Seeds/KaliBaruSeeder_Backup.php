...
class KaliBaruSeeder extends Seeder
{
    public function run()
    {
        ...
        $configData = [
            ...
            'village_logo'    => 'logo_bekasi.jpg', // Updated logo
        ...
        // 2. News (Berita) - Context: Jan 2026
        $newsData = [
            [
                ...
                'thumbnail'     => 'flood_release.jpg', // Placeholder
                'status'        => 'published',
                'category_id'   => 1, // Assumed General/News ID
                'user_id'       => 1,
            ...
            [
                ...
                'thumbnail'     => 'culture_fest.jpg', // Placeholder
                'status'        => 'published',
                'category_id'   => 2, // Assumed Event/Agenda ID
                'user_id'       => 1,
            ...
            [
                ...
                'thumbnail'     => 'cleanup.jpg', // Placeholder
                'status'        => 'published',
                'category_id'   => 1,
                'user_id'       => 1,
            ...
            [
                ...
                'thumbnail'     => 'park_opening.jpg', // Placeholder
                'status'        => 'published',
                'category_id'   => 1,
                'user_id'       => 1,
            ...
            [
                ...
                'thumbnail'     => 'flood_team.jpg', // Placeholder
                'status'        => 'published',
                'category_id'   => 1,
                'user_id'       => 1,
            ...
            [
                ...
                'thumbnail'     => 'fogging.jpg', // Placeholder
                'status'        => 'published',
                'category_id'   => 2,
                'user_id'       => 1,
            ...
            [
                ...
                'thumbnail'     => 'gotong_royong.jpg', // Placeholder
                'status'        => 'published',
                'category_id'   => 2,
                'user_id'       => 1,
        ...
        // Insert News (Handle categories first if needed, but assuming ID 1 & 2 exist or just using 1)
        ...
        // 5. Users (Pastikan admin ada)
        // Kita tidak akan truncate users sembarangan jika sudah ada, tapi untuk memastikan setidaknya ada 1 admin
        $adminExist = $this->db->table('users')->where('username', 'admin')->countAllResults();
        if ($adminExist == 0) {
